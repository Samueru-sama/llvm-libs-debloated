...
sed -i -e 's/-g1/-g0/' \
	...
	-e 's|-DLLVM_BUILD_TESTS=ON|-DLLVM_BUILD_TESTS=OFF -DLLVM_ENABLE_LIBXML2=OFF -DLLVM_ENABLE_ZSTD=OFF -DLLVM_ENABLE_LIBEDIT=OFF -DLLVM_ENABLE_LIBPFM=OFF|' \
	-e 's|-DLLVM_ENABLE_FFI=ON|-DLLVM_ENABLE_FFI=OFF|' \
