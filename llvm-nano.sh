...
sed -i -e 's/-g1/-g0/' \
	...
	-e 's|-DLLVM_ENABLE_SPHINX=ON|-DLLVM_ENABLE_SPHINX=OFF -DLLVM_DYLIB_COMPONENTS="core;ipo;X86;X86DESC;X86CODEGEN;X86ASMPARSER;X86ASMPRINTER;AMDGPU;AMDGPUDESC;AMDGPUCODEGEN;AMDGPUASMPARSER;AMDGPUASMPRINTER"|' \
