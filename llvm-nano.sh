...
"x86_64")
	...
	EXTRA="-DLLVM_DYLIB_COMPONENTS='core;ipo;X86;X86DESC;X86CODEGEN;X86ASMPARSER;X86ASMPRINTER;AMDGPU;AMDGPUDESC;AMDGPUCODEGEN;AMDGPUASMPARSER;AMDGPUASMPRINTER'"
	EXT="zst"
	;;
"aarch64")
