...
"x86_64")
	...
	EXTRA="-DLLVM_DYLIB_COMPONENTS='core;ipo;X86;X86DESC;X86CODEGEN;X86ASMPARSER;AMDGPU;AMDGPUDESC;AMDGPUCODEGEN;AMDGPUASMPARSER'"
	EXT="zst"
	;;
"aarch64")
...
sed -i -e 's/-g1/-g0/' \
	...
	-e 's|-DLLVM_ENABLE_RTTI=ON|-DLLVM_ENABLE_LTO=Thin|' \
	...
	-e "s|-DLLVM_ENABLE_SPHINX=ON|-DLLVM_ENABLE_SPHINX=OFF $EXTRA|" \
